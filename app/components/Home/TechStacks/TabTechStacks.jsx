  ...
  return (
    <>
      {tabData?.icon?.data?.attributes?.url && (
        <div
          className="fill-color bg-[#F6F7F9] rounded-[4px] p-[10px] md:p-[15px] text-center hover:bg-[#62207E] hover:text-[#fff] img-hover min-w-[126px] md:min-w-[130px]"
          key={index}
        >
          <div className="text-center">
            ...
            <CloudinaryImage
              ...
              className="md:w-[30px] md:h-[30px] w-[20px] h-[20px] mx-auto mb-[6px]"

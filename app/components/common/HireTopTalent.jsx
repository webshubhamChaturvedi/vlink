...
export default function HireTopTalent() {
  ...
  const handleDateChange = (date) => {
    ...
    const minTimeForSelectedDate =
      date.getDate() === currentDate.getDate()
        ? setHours(
            setMinutes(currentTime, getMinutes(currentTime)),
            getHours(currentTime)
          )
        : setHours(setMinutes(date, 0), 10);

    setStartDate(date);
    setMinTime(minTimeForSelectedDate);
  };
  const [minTime, setMinTime] = useState(
    setHours(setMinutes(currentDate, 0), getHours(currentDate))
  );
  // dateTime picker Script End
  ...
  if (Intl) {
    ...
    timeZoneCityToCountry.map((coun, key) => (
      <span key={key}>{(userCountry = coun[userCity])}</span>
    ));
  }
  ...
  var ScheduleDateTime = date.toLocaleString();
  ...
  const ScheduleCall = async (data) => {
    if (
      ...
      try {
        const formData = {
          ...data,
          dateText: ScheduleDateTime,
        };
        var data = new FormData();
        data.append("files.UploadImage", file);
        data.append(
          "data",
          JSON.stringify({
            name: formData?.name,
        ...
        const res = await REQUEST({
          data: data,
          method: "POST",
          url: API_ENDPOINTS.HIRE_EMPLOYEES_EMPS,
        });
        ...
        if (res?.status === 200) {
          ...
          sidebarContentEl.classList.add("sahedule-call-successfull");
          setCaptchaError(false);
  ...
  return (
    <div
      ...
      id="some-id"
      className=" hidden fixed top-0 right-0 left-0 bottom-0 z-50 h-full overflow-y-auto overflow-x-hidden bg-[rgba(0,_0,_0,_.5)] flex justify-center items-center"
    >
      <section
        className="bg-[#fff] rounded-[20px] overflow-y-auto max-w-[1200px] relative max-h-[97vh]   mb-2 mt-5 md:mt-0"
        onClick={(e) => {
          e.stopPropagation();
        }}
      >
        <div className="grid grid-cols-12">
          <div className="col-span-4 bg-[radial-gradient(79.7%_78.42%_at_30.94%_25.67%,_#022F78_0%,_#0B0924_100%)] p-[30px] md:block hidden">
            <div className="">
                ...
                <div className="flex flex-wrap -mx-3">
                  ...
                  <div className="w-full md:w-1/2 mb-6 md:mb-0">
                    <div className="w-full px-3 mb-3">
                      ...
                      <div className="relative">
                        <div className="z-[1] absolute left-[10px_!important] inset-y-0 start-0 flex items-center  pointer-events-none w-[20px]">
                          <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                          >
                            <g clipPath="url(#clip0_10169_3009)">
                              <path
                ...
                <div className="flex flex-wrap -mx-3">
                  <div className="w-full md:w-1/2 mb-6 md:mb-0">
                    <div className="w-full px-3 mb-3">
                      ...
                      <div className="relative">
                        <div className="absolute left-[10px_!important] inset-y-0 start-0 flex items-center  pointer-events-none w-[20px]">
                          <svg
                            width="29"
                            height="29"
                            viewBox="0 0 29 29"
                        ...
                        >
                          ...
                          {modal?.employeeBudget?.map((value, key) => (
                            <option value={value.productType} key={key}>
                              {value.productType}
                            </option>
                          ))}
                        </select>
                      ...
                      {errors.Budget && (
                        <span class="mt-2 font-normal text-sm text-red-700">
                    ...
                    <div className="w-full px-3 mb-3">
                      ...
                      <div className="relative">
                        ...
                        >
                          ...
                          {modal?.employeeStaffing?.map((value, key) => (
                            <option value={value.productType} key={key}>
                              {value.productType}
                            </option>
                          ))}
                    ...
                    <div className="w-full px-3 mb-3">
                      ...
                      <div className="relative">
                        ...
                        >
                          ...
                          {modal?.contactEmpForm?.map((value, key) => (
                            <option value={value.productType} key={key}>
                              {value.productType}
                            </option>
                          ))}
                  ...
                  <div className="w-full md:w-1/2 mb-6 md:mb-0">
                    <div className="w-full px-3 mb-3">
                      <label
                        ...
                        htmlFor="grid-first-name"
                      >
                        Drag & Drop any files you feel would be useful
                      </label>
                      <div className="relative">
                        <div className="absolute left-[10px_!important] top-[5px] start-0 flex items-center  pointer-events-none w-[20px]">
                          <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                        ...
                        <div className="flex flex-wrap items-center justify-center w-full">
                          ...
                          >
                            <>
                              <p className="text-[14px] text-[#00102B]">
                                Upload File
                              </p>
                              <input
                                id="dropzone-file"
                        ...
                        {file && (
                          <div className="text-[green] text-[14px] fill-[green] bg-[#dadada40] mt-1 px-2 py-1 rounded-[5px] flex justify-space-between items-center">
                            <p className="w-[100%]">{file.name}</p>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              height="16"
                              width="16"

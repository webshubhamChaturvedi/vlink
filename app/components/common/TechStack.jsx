...
import "app/components/common/tchstack.css";
        ...
        <div className="lg:border-[1px] border-[#7F7D7D] rounded-[70px] lg:p-[55px]">
          <div className="grid lg:grid-cols-12 md:grid-cols-12 sm:grid-cols-12 gap-7">
            <div className="lg:col-span-4 col-span-12">
              <div className="gradient p-[30px] text-center mb-[60px]">
              ...
              <div className="gradient p-[30px] text-center">
            ...
            <div className="lg:col-span-8 col-span-12">
              <div className="gradient p-[30px] mb-[60px] h-full">
                ...
                <ul>
                  {techstack?.featureList?.map((items, key) => (
                    <li
                      key={key}
                      className="text-[18px] text-[#011123] font-[400] flex items-center mb-8"
                    >
                      <CloudinaryImage

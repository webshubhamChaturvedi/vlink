...
export default function CaseStudySection({ data }) {
  ...
  useEffect(() => {
    if (typeof window !== "undefined" > 767) {
      const handleScroll = () => {
        ...
        const sectionHeight = maxScrollTop / 2;
  ...
  let imageUrls = data?.case_list?.map((list, key) =>
  ...
  return (
    <section>
        ...
        <div className="flex flex-col md:flex-row md:justify-around items-center">
          <div className="succesful-team md:basis-full">
            <h4 className="font-bold text-black xl:text-4xl lg:text-[32px] text-[22px] text-center xl:leading-[45px] lg:leading-[35px]">
              <span
                className="inline-block font-bold bg-no-repeat bg-size-60 bg-[center_bottom_80%] pt-16 max-w-[800px]"
                style={{
      ...
      <div className="container md:py-[55px] py-[30px] lg:px-[10%] pb-0 md:pb-12">
        <div

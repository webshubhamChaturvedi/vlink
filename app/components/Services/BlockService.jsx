        ...
        <div className="lg:flex items-center">
          <div className="lg:mb-0 mb-4">
            <div className="bg-[#0F2278] shadow-[0px_30px_25px_0px_#010F261F] py-10 px-6 rounded-[10px_0px_0px_10px]">
              <h4 className="relative font-bold text-white lg:text-[32px] text-[22px] text-left lg:leading-[35px] mb-3">
                <span className="lg:text-[80px] text-[60px] font-[800] gradient_text block w-[100%] leading-[80px]">
              ...
              <p className="text-[#ffffffa6] lg:text-[16px] text-[16px] font-[400] max-w-[500px] leading-[1.8]">
                {BlockService?.description}
              </p>
          ...
          <div>
            {BlockService?.serviceList?.map((items, key, arr) => (
              <div
                key={key}
                className={`md:p-[30px] p-[20px] md:pl-[50px] shadow-[0px_30px_25px_0px_#010F261F] ${
                  arr.length - 1 === key ? "rounded-[0px_0px_10px_10px]" : ""
                } ${
                  key === 0
              ...
              >
                <h6 className="font-[600] text-[#fff] lg:text-[20px] text-[16px]">
                  {items?.title}
                </h6>
                <p className="text-[#ffffffa6] lg:text-[14px] text-[13px]">
                  {items?.description}
                </p>
              </div>
            ))}

...
export default function ReEngineeringLegacy({
  dedicatedTeamsData,
  offering,
  trusted,
  testimonials,
  ...
  const header = [
    ...
    { label: "Re-engineering Legacy Apps & Products" },
  ];
...
export async function getStaticProps() {
  const [dedicatedTeamsData, offering, trusted, testimonials] =
    await Promise.all([
      REQUEST({
        method: "GET",
        url: API_ENDPOINTS.SERVICES_RE_ENGINEERING_LEGACY_APPS_AND_PRODUCTS,
      }),
      REQUEST({
        method: "GET",
